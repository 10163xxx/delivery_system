...
object ValidationMessages:
  ...
  object Merchant:
    ...
    val MenuItemRemainingQuantityInvalid: ErrorMessage = errorMessage("限量库存需在 1 到 10 之间")
    ...
    val MenuItemStockInvalid: ErrorMessage = errorMessage("剩余份数需在 0 到 10 之间，留空表示不限量")
