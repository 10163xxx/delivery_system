        ...
        <div className="merchant-store-content">
          ...
          <section className="merchant-section-card">
            ...
            <div className="ticket-grid">
              {merchantProfile?.withdrawalHistory?.length ? merchantProfile.withdrawalHistory.map((entry) => (
