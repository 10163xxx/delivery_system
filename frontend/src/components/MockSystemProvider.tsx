...
type AnyMockDialogRequest = MockDialogRequest<MockResultOption<string, unknown>>
...
export function MockSystemProvider({ children }: { children: ReactNode }) {
  ...
  const contextValue = useMemo(
    () => ({
      openMockDialog: <TOption extends MockResultOption<string, unknown>>(request: MockDialogRequest<TOption>) =>
