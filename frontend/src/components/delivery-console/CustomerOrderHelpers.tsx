import { DEFAULT_PARTIAL_REFUND_QUANTITY } from '@/features/delivery-console'
import { OrderChatPanel } from '@/components/delivery-console/OrderChatPanel'

export function renderPartialRefundActions(order: any, props: any) {
  const {
  ...
  return (
    <div className="panel-stack">
      {order.items.map((item: any) => {
        ...
        const draft = partialRefundDrafts[draftKey] ?? { quantity: DEFAULT_PARTIAL_REFUND_QUANTITY, reason: '' }
...
export function renderOrderChat(order: any, props: any) {
  const {
    selectedCustomer,
    orderChatDrafts,
    orderChatErrors,
...
export function renderCustomerOrderFooter(order: any, props: any) {
...
export function CustomerOrderDetailSection({ order, props }: any) {
  const {
    stateTickets,
    afterSalesDrafts,
    afterSalesErrors,
