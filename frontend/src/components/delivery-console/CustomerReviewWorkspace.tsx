import { DEFAULT_REVIEW_RATING, LOW_RATING_MAX, MAX_RATING, MIN_RATING } from '@/features/delivery-console'
...
export function CustomerReviewWorkspace(props: any) {
  const {
    activeReviewOrder,
    REVIEW_WINDOW_DAYS,
    reviewErrors,
          ...
          <div className="review-dialog-form">
            <section className="review-rating-field">
              ...
              <div className="action-row">
                ...
                <button className="primary-button" disabled={!hasPendingStoreReview(activeReviewOrder)} onClick={() => void submitReview(activeReviewOrder.id, 'store')} type="button">
            ...
            {activeReviewOrder.riderId ? (
              <section className="review-rating-field">
                ...
                <div className="action-row">
                  ...
                  <button className="primary-button" disabled={!hasPendingRiderReview(activeReviewOrder)} onClick={() => void submitReview(activeReviewOrder.id, 'rider')} type="button">
