...
function StoreSearchBar({ props }: { props: CustomerRoleProps }) {
  const {
...
function SearchHistoryPanel({ props }: { props: CustomerRoleProps }) {
  const {
...
function CustomerStatusBar({ props }: { props: CustomerRoleProps }) {
...
function StoreCategoryGrid({ props }: { props: CustomerRoleProps }) {
...
function StoreBrowseEmptyState({ props }: { props: CustomerRoleProps }) {
