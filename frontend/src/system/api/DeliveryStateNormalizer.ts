import type { AdminTicket, AdminTicketResolution, AdminTicketSubmission } from '@/objects/admin/afterSales/AdminTicket'
...
} from '@/objects/order/afterSales/OrderPartialRefundRequest'
import type {
  OrderSummary,
...
import type { DeliveryOrderState } from '@/objects/domain/DomainSlices'
