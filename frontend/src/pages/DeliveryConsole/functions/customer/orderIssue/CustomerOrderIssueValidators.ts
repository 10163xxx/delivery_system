...
import { AFTER_SALES_REQUEST_TYPE, APPLICATION_STATUS, ORDER_STATUS } from '@/objects/core/SharedObjects'
import { REVIEW_TARGET } from '@/pages/DeliveryConsole/objects/ReviewTargetObjects'
import { buildAfterSalesPayload, buildPartialRefundPayload, buildReviewPayload } from '@/pages/DeliveryConsole/functions/payloads/DeliveryPayloadCustomer'
import { canReviewOrder } from '@/pages/DeliveryConsole/functions/review/DeliveryReview'
import { createInitialAfterSalesDraft, createInitialReviewDraft } from '@/pages/DeliveryConsole/functions/drafts/DeliveryDrafts'
import { DELIVERY_CONSOLE_MESSAGES, formatMaxPartialRefundQuantityMessage } from '@/pages/DeliveryConsole/functions/shared/DeliveryMessages'
import { LOW_RATING_MAX } from '@/pages/DeliveryConsole/functions/shared/DeliveryConstants'
import { buildPartialRefundDraftKey, buildReviewDraftKey } from '@/pages/DeliveryConsole/objects/DeliveryDraftObjects'
import type {
...
export function validateCustomerReviewSubmission(
  params: CustomerOrderIssueParams,
  orderId: OrderId,
...
export function validateAfterSalesDraft(params: CustomerOrderIssueParams, orderId: OrderId) {
