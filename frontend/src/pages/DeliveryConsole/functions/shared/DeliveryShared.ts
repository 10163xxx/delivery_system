import { MAX_RATING, MIN_RATING } from '@/pages/DeliveryConsole/functions/shared/DeliveryConstants'
import { DELIVERY_INPUT_PATTERNS } from '@/pages/DeliveryConsole/functions/shared/DeliveryPatterns'
import type { RawBooleanValue, RawNumericValue, RawTextValue } from '@/objects/core/SharedObjects'
