...
} from '@/pages/DeliveryConsole/components/primitives/DeliveryConsoleCopy'
import { CUSTOMER_WORKSPACE_VIEW } from '@/pages/DeliveryConsole/objects/CustomerWorkspaceObjects'
import type { CustomerWorkspaceHeaderProps } from '@/pages/CustomerConsole/objects/CustomerPanelObjects'
