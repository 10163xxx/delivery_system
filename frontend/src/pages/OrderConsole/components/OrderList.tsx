import type { OrderListProps } from '@/pages/OrderConsole/objects/OrderPageObjects'
import { ORDER_LIST_COPY } from '@/pages/DeliveryConsole/functions/shared/DeliveryMessages'
