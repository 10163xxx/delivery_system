...
import { MerchantMenuComposer } from '@/pages/MerchantConsole/components/console/menu/MerchantMenuComposer'
import { MerchantMenuCatalog } from '@/pages/MerchantConsole/components/console/menu/MerchantMenuCatalog'
