import type { MerchantMenuImageFieldsProps } from '@/pages/MerchantConsole/objects/MerchantConsoleObjects'
import { MENU_ITEM_FORM_FIELD } from '@/pages/DeliveryConsole/objects/MerchantWorkspaceObjects'
