...
import type { AdminRoleProps, CustomerRoleProps, MerchantRoleProps, RiderRoleProps } from '@/shared/app/role-props'
import type { AuthSession, DeliveryAppState, Role } from '@/shared/object/core/SharedObjects'
...
export type CustomerWorkspaceViewMeta = {
  ...
  readonly activeTab: keyof typeof import('@/shared/components/primitives/DeliveryConsoleCopy').CUSTOMER_WORKSPACE_HEADER_TABS
}
