...
import type { Latitude, Longitude, RawNumericValue, RawTextValue } from '@/objects/domain/DomainTypes'
import { asDomainNumber } from '@/features/delivery/DeliveryShared'
import { toMapCoordinate } from '@/features/delivery/DeliveryCoordinateSystem'
import {
